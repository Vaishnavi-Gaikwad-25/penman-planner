    ...
    irrigation_recommendations = [
        {
            ...
            "evaporation_consideration": "Moderate losses expected"
        },
        {
            "period": "Summer (Jun-Aug)",
            "irrigation_frequency": "Every 3-4 days",
            "water_requirement": "High",
            "evaporation_consideration": "High losses - increase water allocation by 30%"
        },
        {
            "period": "Autumn (Sep-Nov)",
            "irrigation_frequency": "Every 7-10 days",
            "water_requirement": "Medium-Low",
            "evaporation_consideration": "Lower losses - reduce irrigation frequency"
        },
        {
            "period": "Winter (Dec-Feb)",
            "irrigation_frequency": "Every 10-14 days",
            "water_requirement": "Low",
            "evaporation_consideration": "Minimal losses - maintain minimal irrigation"
        }
    ]
